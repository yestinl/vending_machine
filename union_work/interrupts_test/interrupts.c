...
//
//*****************************************************************************
#define GPIO_A_BASE     GPIO_PORTN_BASE
#define GPIO_A_PIN      GPIO_PIN_1
#define GPIO_B_BASE     GPIO_PORTN_BASE
#define GPIO_B_PIN      GPIO_PIN_0
#define GPIO_C_BASE     GPIO_PORTF_BASE
#define GPIO_C_PIN      GPIO_PIN_4
